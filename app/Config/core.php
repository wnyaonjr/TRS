 ...
 */
	Configure::write('Security.salt', 'Nv+AltPx+5W5zDEQ~vdrsp^gUKYfPtVb_bxaQbIoOfiMf8ojl78y8UWXAUxT');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', 'bviY QMuf+B852zfspLpc-^5LQlDYwVDcsEAk87^Ce6tNFa~0sSv|tR8%-3p');
